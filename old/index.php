  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li><a href="pronos.php">Pronostics</a></li>
    ...
    <div class="container">
      ...
      <div class="hero-unit">
		...
		<button type="button" class="btn btn-success btn-large" onclick="return bet();">Parier</button>
		<hr/>
	  ...
	  <!-- Modal -->
		<div id="AddProno" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modalProno" aria-hidden="true">
		  ...
		  <div class="modal-footer">
			...
			<button class="btn btn-primary" onclick="return addProno();">Enregistrer</button>
		  </div>
		</div>
      ...
      <div class="row">
        <div class="span4">
          ...
          <p><a class="btn" href="#">Détails &raquo;</a></p>
        </div>
        <div class="span4">
          <h3>Lancer un pronostic</h3>
          <p><a href="#AddProno" role="button" class="btn" data-toggle="modal">Lancer</a></p>
        </div>
      </div>
